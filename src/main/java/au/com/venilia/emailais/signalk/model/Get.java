...
public class Get {
    ...
    /**
     * The relative path to GET,  supports jsonPath syntax for complex matches
     * (Required)
     * 
     */
    @JsonProperty("path")
    @JsonPropertyDescription("The relative path to GET,  supports jsonPath syntax for complex matches")
    private String path;
    @JsonIgnore
